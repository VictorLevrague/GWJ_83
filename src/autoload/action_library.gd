...
var negative_action_pool: Array[Action] = [Action.new("Stole candies from a kid", 10),
                                ...
                                Action.new("Shakes hand after toilets without hand cleaning", 20),
                                Action.new("Started a World War", 200),
                                Action.new("Cheats on partner", 50),
                                Action.new("Abandonned a pet", 100),
                                Action.new("Lies frequently", 15),
                                Action.new("Drives being drunk", 80),
                                Action.new("Murdered a human", 150),
                                Action.new("Never says thank you", 15),
                                Action.new("Abandonned a child", 80),
                                Action.new("Eradicated an animal species", 300),
                                Action.new("Speaks loudly on public transports", 25),
                                Action.new("Scammed a Kickstarter project", 30),
                                Action.new("Robbed a bank", 50),
                                Action.new("Pays employees below minimum wage", 50),
                                Action.new("Started a forest fire", 70),
                                Action.new("Didn't say hello during an interview", 5),
                                Action.new("Interrupts people constantly", 10),
...
var positive_action_pool: Array[Action] = [Action.new("Gave money to charity", 30),
                                ...
                                Action.new("Volunteer for a humanitarian association", 50),
                                Action.new("Regular blood donator", 40),
                                ...
                                Action.new("Helped a grandma to cross the street", 5),
                                Action.new("Protected younger against bullies at school", 25),
                                ...
                                Action.new("Developed video games", 30),
                                Action.new("Donated hairs for cancer patients", 35),
                                Action.new("Brought a lost cat to the veterinarian", 40),
                                Action.new("Translates books for free", 20),
                                Action.new("Teaching disadvantadged children", 40),
                                Action.new("Helped rebuild homes after a natural disaster", 80),
                                Action.new("Leave a sit for a pregnant person", 5),
